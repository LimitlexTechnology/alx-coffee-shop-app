         ...
         <View style={{ width: '100%', maxWidth: 1024, flex: 1 }}>
            ...
            >
               <View className={`px-6 ${isLargeScreen ? 'flex-row gap-8 py-6' : ''}`}>
                  {/* Left Column (Deliver/Pickup, Address, Cart Items) */}
                  ...
                  {/* Right Column (Discount, Summary, Payment, Order Button) */}
                  <View className={`${isLargeScreen ? 'flex-1' : ''}`}>
                     {/* Discount Row */}
                     ...
                     <View className="bg-white rounded-xl p-4 mb-3 shadow-sm">
                        ...
                        {isLargeScreen && (
                           <View className="flex-row justify-between border-t border-coffee-gray/30 pt-3">
                              <Text className="text-base font-bold text-coffee-text">Total</Text>
                              <Text className="text-base font-bold text-coffee-primary">$ {total.toFixed(2)}</Text>
                           </View>
                        )}
                     </View>
                     ...
                     {/* Order Button (Inline for Large Screens) */}
                     {isLargeScreen && (
                        <TouchableOpacity
            ...
            {/* Bottom Order Button (Sticky for Small Screens) */}
            {!isLargeScreen && (
               <View className="bg-white border-t border-coffee-gray/20 absolute bottom-0 left-0 right-0">
